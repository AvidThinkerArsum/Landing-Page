...
export function TabsList({ children, className }: TabsListProps) {
  return (
    <div className={cn("inline-flex h-9 items-center justify-center rounded-lg bg-depth-2 p-1 text-foreground/70", className)}>
      {children}
    </div>
  );
}
  ...
  return (
    <button
      ...
      className={cn(
        ...
        isActive ? "bg-depth-1 text-foreground shadow" : "text-foreground/70 hover:text-foreground",
        className
      )}
    >
      {children}
...
export function TabsContent({ value: contentValue, children, className }: TabsContentProps) {
  ...
  return (
    <div className={cn("mt-2 ring-offset-background focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-primary focus-visible:ring-offset-2", className)}>
      {children}
    </div>
  );
}
